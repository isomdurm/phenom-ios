...
internal class DKAssetGroupDetailVC: UICollectionViewController, DKGroupDataManagerObserver {
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red:23/255, green:23/255, blue:25/255, alpha:1) //UIColor.whiteColor()
        
        self.collectionView!.backgroundColor = UIColor(red:23/255, green:23/255, blue:25/255, alpha:1) //UIColor.whiteColor()
